...
description: 'During this session David will discuss: How to use Sonar to help improve product quality (Unit Test coverage, Integration Test coverage, static code analysis) | AEM use case | Q&A Global presentation of Sonar application'
